    ...
    return (
        ...
        transition={{staggerChildren: 0.2}}
         id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            ...
            viewport={{once: true}}
            onSubmit={handleOnSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
                ...
                <div className='sm:col-span-2'>
                    ...
                    <textarea rows={8} placeholder='Enter your massage' required name='massage' className='w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' />
                </div>

                <button className='w-max flex gap-2 bg-primary text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all' type='submit'>Submit <img className='w-4' src={assets.arrow_icon} alt="" /> </button>
